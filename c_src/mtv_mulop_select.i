...
{
    switch(type) {
    case INT8: MT_NAME(mtv_,_int8)((int8_t*)ap,as,an,am,(int8_t*)bp,bs,bn,bm,(int8_t*)cp,cs); break;
    case INT16: MT_NAME(mtv_,_int16)((int16_t*)ap,as,an,am,(int16_t*)bp,bs,bn,bm,(int16_t*)cp,cs); break;
    case INT32: MT_NAME(mtv_,_int32)((int32_t*)ap,as,an,am,(int32_t*)bp,bs,bn,bm,(int32_t*)cp,cs); break;
