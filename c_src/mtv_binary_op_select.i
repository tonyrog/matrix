		   ...
		   PARAMS_DECL)
{
    LOCALS_DECL
    switch(type) {
    case INT8: MT_NAME(mtv_,_int8)((int8_t*)ap,as,(int8_t*)bp,bs,(int8_t*)cp,cs,n,m PARAMS); break;
    case INT16: MT_NAME(mtv_,_int16)((int16_t*)ap,as,(int16_t*)bp,bs,(int16_t*)cp,cs,n,m PARAMS); break;
    case INT32: MT_NAME(mtv_,_int32)((int32_t*)ap,as,(int32_t*)bp,bs,(int32_t*)cp,cs,n,m PARAMS); break;
